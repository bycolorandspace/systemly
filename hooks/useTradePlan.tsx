...
export function useTradeplan() {
  ...
  // Separate mock function for clarity
  ...
  const uploadData = async (
    ...
    // const imageFile = data.image; // Assuming data.image is a File object
    // const formData = new FormData();
    ...
    //   setError("No user inputs to upload");
    //   return;
    // } else {
